...
public static class ComputerWallpaperPolicy
{
	public static string GetBackgroundStyle( string? wallpaper )
	{
		return Normalize( wallpaper ) switch
		{
			...
			_ => "background-image: url(\"/Assets/desktopBackground.png\"); background-size: cover; background-position: center; background-repeat: no-repeat; background-color: #2c7cb7;"
		};
	}
